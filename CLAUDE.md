...
## 프로젝트 개요
여러 명의 AI 에이전트들이 각자 맡은 일을 어디까지 진행했는지 칸반 보드 위에서 한눈에 지휘하는 "AI 에이전트 오케스트레이션 칸반 보드"
기획, 코딩, 테스트 등 단계별로 에이전트들이 카드를 옮겨가며 협업하는 모습을 모니터링하고 필요할 때 피드백을 전달
혼자서 10명의 AI 직원을 이끄는 1인 소프트웨어 회사의 대표가 된 듯한 궁극의 프로젝트 지휘 경험 선사
